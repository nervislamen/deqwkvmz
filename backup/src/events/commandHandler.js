...
module.exports = async (msg) => {
  ...
  if (cmd) {
    ...
    cmd.run({client: client,  embed: embed, msg: msg, args: args, prefix: prefix, guild: guild, author: author, uye: uye, cfg: cfg, fs: fs, MessageEmbed: MessageEmbed, Discord: Discord, moment: moment, Database: Database, MessageAttachment: MessageAttachment, ms: ms});
  }
};
